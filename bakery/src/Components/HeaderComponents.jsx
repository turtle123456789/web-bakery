        ...
        <Navbar fluid className='py-[21px] px-[9px]'>
          ...
          <div className="flex md:order-2">
            <div className='relative w-[170px]'>
              ...
              <input  placeholder='Search for products' className="w-full text-xs h-[40px] rounded-full border-black	 border-2 pl-10 outline-none focus:outline-none focus:ring-0  focus:border-black" type="text" />
            </div>
          ...
          <Navbar.Collapse>
            <Navbar.Link as={Link} to="/product/Cakes" className='font-bold text-xs' >
              Cakes
            </Navbar.Link>
            <Navbar.Link as={Link} to="/product/Platters" className='font-bold text-xs' >Platters</Navbar.Link>
            <Navbar.Link as={Link} to="/product/Pâtisserie" className='font-bold text-xs' >Pâtisserie</Navbar.Link>
            <Navbar.Link as={Link} to="/product/Tarts" className='font-bold text-xs' >Tarts</Navbar.Link>
            <Navbar.Link as={Link} to="/product/Bread" className='font-bold text-xs' >Bread</Navbar.Link>
            <Navbar.Link as={Link} to="/product/Macarons" className='font-bold text-xs' >Macarons</Navbar.Link>
          </Navbar.Collapse>
        </Navbar>
      </div>
    </div>
